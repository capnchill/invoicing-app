...
<div class="invoice-line-item">
	<div class="col-span-1 py-5 text-right font-bold text-monsoon sm:col-span-2 print:col-span-3">
		Discount
	</div>
	<div class="relative">
		<input
	...
	<div class="py-5 text-right font-mono print:pr-0">{discountedAmount}</div>
</div>
